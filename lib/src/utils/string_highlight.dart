// Fonte -> https://github.com/remoteportal/substring_highlight
...
class StringHighlight extends StatelessWidget {
  ...
  /// The sub-string that is highlighted inside {StringHighlight.text}.  (Either term or terms must be passed.  If both are passed they are combined.)
  final String? term;

  /// The array of sub-strings that are highlighted inside {StringHighlight.text}.  (Either term or terms must be passed.  If both are passed they are combined.)
  final List<String>? terms;

  /// The String searched by {StringHighlight.term} and/or {StringHighlight.terms} array.
  final String text;
